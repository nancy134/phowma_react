...
export default class Race extends Component {
  ...
  componentDidMount(){
    States.search("min", (states) => {
      var ip_state = this.state.ipState.toLowerCase();
    ...
    <Container>
      <Row>
        <Col md={{size: 12}} className="mt-5">
          <Alert color="primary">
            <h4 className="text-center phowma_headline"><a href="https://www.nytimes.com/2018/06/11/us/politics/supreme-court-upholds-ohios-purge-of-voting-rolls.html" className="alert-link fade in" target="_blank">Supreme Court Upholds Ohio’s Purge of Voting Rolls</a></h4>
          </Alert>
        </Col>
      </Row>
      <Jumbotron>
